...
with predict_current_match:
    ...
    if (
        ...
        data = get_current_match_prediction(summoner_name, region, tagline)
...
with predict_last_match:
    ...
    if (
        ...
        data = get_last_match_prediction(summoner_name, region,taglinez)
